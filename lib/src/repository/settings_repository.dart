...
Future<dynamic> setCurrentLocation() async {
  ...
  location.requestService().then((value) async {
    location.getLocation().then((_locationData) async {
      print("this is location ${_locationData.latitude}");
      String _addressName = await mapsUtil.getAddressName(new LatLng(_locationData?.latitude, _locationData?.longitude), "AIzaSyD8M75GSdfWDTkqwB2CCEsTsUltWzB2T_E");
      print("this is location ${_addressName}");
