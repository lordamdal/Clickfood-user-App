...
class SearchResultWidgetHome extends StatefulWidget {
  final String heroTag;

  SearchResultWidgetHome({Key key, this.heroTag}) : super(key: key);

  @override
  _SearchResultWidgetHomeState createState() => _SearchResultWidgetHomeState();
}

class _SearchResultWidgetHomeState extends StateMVC<SearchResultWidgetHome> {
  SearchController _con;

  _SearchResultWidgetHomeState() : super(SearchController()) {
    _con = controller;
  }
