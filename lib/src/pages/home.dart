...
import 'package:food_delivery_app/src/elements/CardWidgetNew.dart';
              ...
              Container(
                ...
                child: StaggeredGridView.countBuilder(
                 ...
                 // physics: sp1,
                  shrinkWrap: true,
                  crossAxisCount: 4,
                  itemCount: _con.allRestaurants.length,
                  itemBuilder: (BuildContext context, int index) {
                    print("all restaurant $index");
                    // if(index==widget.restaurantsList.length-1){
                    //   widget.con.build++;
                    //   print(widget.con.build);
                    // }
                    return GestureDetector(
                      onTap: () {
                        Navigator.of(context).pushNamed('/Details',
                            arguments: RouteArgument(
                              id: '0',
                              param: _con.allRestaurants.elementAt(index).id,
                              heroTag: "home_all_restaurants",
                            ));
                      //  Navigator.of(context).push(MaterialPageRoute(builder: (context) => MenuWidget(parentScaffoldKey: widget.parentScaffoldKey, routeArgument: RouteArgument(param: _con.allRestaurants.elementAt(index))) ));
                        // Navigator.of(context).pushNamed('/Details',
                        //     arguments: RouteArgument(
                        //       id: '0',
                      ...
                      child: CardWidgetNew(restaurant: _con.allRestaurants.elementAt(index), heroTag: "home_all_restaurants"),
                    );
                  },
//                  staggeredTileBuilder: (int index) => new StaggeredTile.fit(index % 2 == 0 ? 1 : 2),
                  staggeredTileBuilder: (int index)=>new StaggeredTile.fit(MediaQuery.of(context).size.width.round()),
