...
class MonetbillPayment extends StatefulWidget {
  MonetBill monetBill;
//  RouteArgument routeArgument;
  MonetbillPayment({Key key, this.monetBill}) : super(key: key);
  @override
  _MonetbillPaymentState createState() => _MonetbillPaymentState();
}

class _MonetbillPaymentState extends StateMVC<MonetbillPayment> {
  CheckoutController _con;

  _MonetbillPaymentState() : super(CheckoutController()) {
    _con = controller;
  }
  @override
  void initState() {
    _con.Monetbilpay(widget.monetBill);
    _con.listenForCarts();
    super.initState();
  }
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    SizedBox(
                      ...
                      child: FlatButton(
                        onPressed: () async{
                        _con.CheckPayment(_con.monetBill);
